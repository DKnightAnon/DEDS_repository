...
CREATE TABLE SALES_STAFF(
    ...
    EMAIL varchar(50),
    DATE_HIRED date,
    SALES_BRANCH_CODE_FSK int FOREIGN KEY REFERENCES SALES_BRANCH(ID_SK),
...
CREATE TABLE SATISFACTION(
    ...
    SALES_STAFF_FSK int FOREIGN KEY REFERENCES SALES_STAFF(ID_SK),
...
CREATE TABLE ORDER_DETAILS (
    ...
    ORDER_METHOD_CODE_PK int,
    ORDER_METHOD_FSK int FOREIGN KEY REFERENCES ORDER_METHOD(ID_SK),

	ORDER_DETAILS_QUANTITY int,

    --Welk product gaat het om?
    PRODUCT_NUMBER int,
	...
	SALES_BRANCH_CODE_FK int,
    SALES_BRANCH_CODE_FSK int FOREIGN KEY REFERENCES SALES_BRANCH(ID_SK),


    RETAILER_FSK int FOREIGN KEY REFERENCES RETAILER(ID_SK),
    RETAILER_SITE_CODE int,

    --Zit dit nu niet al in Retailer?
...
CREATE TABLE RETURNED_ITEM(
    ...
    ORDER_DETAIL_CODE_FSK int FOREIGN KEY REFERENCES ORDER_DETAILS(ID_SK),
    ...
    RETURN_REASON_FK int,
    RETURN_REASON_FSK int FOREIGN KEY REFERENCES RETURN_REASON(ID_SK)
); 
...
CREATE TABLE STAFF_TRAINING(
    ...
    Year_PK int,
    SALES_STAFF_CODE_PK int,
    SALES_STAFF_CODE_FSK int FOREIGN KEY REFERENCES SALES_STAFF(ID_SK),
    ...
    SATISFACTION_FK int,
    SATISFACTION_FSK int FOREIGN KEY REFERENCES SATISFACTION(ID_SK),
...
SELECT * FROM GO_SALES_INVENTORY_LEVELSData

SELECT * FROM GO_SALES_PRODUCT_FORECASTData

SELECT * FROM ORDER_METHOD
